...
exports.getSchedule = (req, res) => {
  let scheduleSearch = async (req) => {
    ...
    let sPlaylistId = pivotDb
      .escape(req.query.playlistId)
      .replace(/['']+/g, "");
...
exports.addSchedule = (req, res) => {
  let fAddSchedule = async (req) => {
    ...
    if (valError.length > 0) {
      ...
      let sScheduleDate = pivotDb
        .escape(objLog.scheduleDate)
        .replace(/['']+/g, "");
      ...
      let sReminderMinutes = pivotDb
        .escape(objLog.reminderMinutes)
        .replace(/['']+/g, "");
...
exports.delSchedule = (req, res) => {
  let fDelSchedule = async (req) => {
    let sScheduleId = pivotDb
      .escape(req.query.scheduleId)
      .replace(/['']+/g, "");
